...
resultAnswer = document.getElementById('answer');
submits = document.getElementById('answerButton');
console.log(state.questionAnswer)

submits.addEventListener('click',(e) => {
  const answer = resultAnswer.value;
  if(answer === state.questionAnswer.toString()){
    //warior should attack
    console.log('benar')
  }else{
    //boss should attack
    console.log('salah')
